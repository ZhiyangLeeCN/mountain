...
import cn.devbuddy.common.netty.concurrent.FastThreadLocalThread;
...
public final class InternalThreadLocalMap {
    ...
    static {
        ...
        logger.debug("-Dcn.devbuddy.threadLocalMap.stringBuilder.initialSize: {}", STRING_BUILDER_INITIAL_SIZE);
        logger.debug("-Dcn.devbuddy.threadLocalMap.stringBuilder.maxSize: {}", STRING_BUILDER_MAX_SIZE);
    }
