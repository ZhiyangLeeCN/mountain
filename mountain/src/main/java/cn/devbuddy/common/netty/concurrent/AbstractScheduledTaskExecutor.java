...
import cn.devbuddy.common.netty.internal.DefaultPriorityQueue;
import cn.devbuddy.common.netty.internal.ObjectUtil;
import cn.devbuddy.common.netty.internal.PriorityQueue;
...
/**
 * Abstract base class for {@link TaskExecutor}s that want to support scheduling.
 */
public abstract class AbstractScheduledTaskExecutor extends AbstractTaskExecutor {
    ...
    protected AbstractScheduledTaskExecutor(TaskExecutorGroup parent) {
        super(parent);
    }
    ...
    /**
     * Called from arbitrary non-{@link TaskExecutor} threads prior to scheduled task submission.
     * Returns {@code true} if the {@link TaskExecutor} thread should be woken immediately to
     ...
     * to wake the {@link TaskExecutor} thread if required.
     *
     * @param deadlineNanos deadline of the to-be-scheduled task
     *     relative to {@link AbstractScheduledTaskExecutor#getCurrentTimeNanos()}
     * @return {@code true} if the {@link TaskExecutor} thread should be woken, {@code false} otherwise
     */
     ...
     *
     * @param deadlineNanos relative to {@link AbstractScheduledTaskExecutor#getCurrentTimeNanos()}
     * @return  {@code true} if the {@link TaskExecutor} thread should be woken, {@code false} otherwise
     */
