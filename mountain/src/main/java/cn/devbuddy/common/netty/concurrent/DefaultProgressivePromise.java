...
import static cn.devbuddy.common.netty.internal.ObjectUtil.checkPositiveOrZero;
...
public class DefaultProgressivePromise<V> extends DefaultPromise<V> implements ProgressivePromise<V> {
     ...
     *
     * It is preferable to use {@link TaskExecutor#newProgressivePromise()} to create a new progressive promise
     *
     * @param executor
     *        the {@link TaskExecutor} which is used to notify the promise when it progresses or it is complete
     */
    public DefaultProgressivePromise(TaskExecutor executor) {
        super(executor);
    }
