...
import cn.devbuddy.common.netty.internal.PriorityQueueNode;
...
final class ScheduledFutureTask<V> extends PromiseTask<V> implements ScheduledFuture<V>, PriorityQueueNode {
    ...
    ScheduledFutureTask(AbstractScheduledTaskExecutor executor,
    ...
    private AbstractScheduledTaskExecutor scheduledExecutor() {
        return (AbstractScheduledTaskExecutor) executor();
    }
